...
from data.CitationGraphs import CitationGraphsDataset,HetDataset
...
def LoadData(DATASET_NAME):
    ...
    # handling for (ZINC) experiments dataset
    ...
    NonHomo_DATASETS = ['deezer-europe', 'pokec', 'snap-patents', 'yelp-chi', 'arxiv-year','chameleon','cornell','actor','squirrel','texas','wisconsin']
    if DATASET_NAME in NonHomo_DATASETS:
        return HetDataset(DATASET_NAME)